...
//import model.data.NeuralNetworkDataManager;
//import model.parser.GraphicsParser;
...
//		dataManager.writeLabelsToFile();
	...
	{
//		parseAllPaintingsInFolder(PropertyManager.getTestDataFolder());
//		System.out.println("Parsed all test paintings.");

//		parseAllPaintingsInFolder(PropertyManager.getMondriaanFolder());
//		System.out.println("Mondriaan paintings done.");
//		parseAllPaintingsInFolder(PropertyManager.getPicassoFolder());
//		System.out.println("Picasso paintings done.");
//		parseAllPaintingsInFolder(PropertyManager.getRubensFolder());
...
//			fileChooser.setInitialDirectory(new File(PropertyManager.getSourceFolder()));
...
//			Process p = Runtime.getRuntime().exec("python " + PropertyManager.getAugmentationScript() + " " + n);
