...
//import model.music.MusicalData;
//import model.music.NeuralNetworkDataManager;
//import model.music.Piece;
//import model.parser.MusicXMLParser;
...
//		dataManager.writeLabelsToFile();
	...
	{
//		parseAllScoresInFolder(PropertyManager.getClassicalFolder());
//		System.out.println("Classical scores done.");
//		parseAllScoresInFolder(PropertyManager.getJazzFolder());
//		System.out.println("Jazz scores done.");
//		parseAllScoresInFolder(PropertyManager.getPopFolder());
...
//		catch (Exception e) {	e.printStackTrace();	}
	...
	{
//		File file = new File(PropertyManager.getResultFolder() + "vectorsMusic.csv");
//		
