...
public class GeneralData 
{
	...
	public enum ClusterType				{KDTREE, LSH}
	...
	public static boolean clusteringVerbose = false;
	
	public static AssociationModelManager associationModelManager;
	
	public static ArrayList<GraphicsInstance> graphicsInstances = new ArrayList<>();
	public static ArrayList<MusicInstance> musicInstances = new ArrayList<>();
	
	public static HashMap<String, Integer> graphicsClasses = new HashMap<>();
	public static HashMap<String, Integer> musicClasses = new HashMap<>();
